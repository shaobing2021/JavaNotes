...
- ![1](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="1280" height="603"></svg>)
...
- ![image-20200727145359501](https://gitee.com/shaobing2021/typora/raw/master/img/20200727174145.png)l)

- 当系统有一个以上CPU时，当一个CPU执行一个进程时，另一个CPU可以执行另一个进程，两个进程互不抢占CPU资源，可以同时进行，我们称之为并行（Parallel）。
- 其实==决定并行的因素不是CPU的数量，而是CPU的核心数量==，比如一个CPU多个核也可以 并行。
- 适合科学计算，后台处理等弱交互场景
- ![image-20200727145410137](https://gitee.com/shaobing2021/typora/raw/master/img/20200727174146.png)
...
- ![image-20200727145435691](https://gitee.com/shaobing2021/typora/raw/master/img/20200727174147.png)
- 并发（Concurrent） ：指用户线程与垃圾收集线程同时执行（但不一定是并行的，可能会交替执行），垃圾回收线程在执行时不会停顿用户程序的运行。
  - ➢用户程序在继续运行，而垃圾收集程序线程运行于另一个CPU上；
  - ➢如： CMS、G1
- ![image-20200727145447309](https://gitee.com/shaobing2021/typora/raw/master/img/20200727174148.png)
...
- ![image-20200727145503931](https://gitee.com/shaobing2021/typora/raw/master/img/20200727174149.png)
...
`StringBuffer str = new StringBuffer ("Hello,尚硅谷");`
 ...
 对应内存结构：
![image-20200727145532241](https://gitee.com/shaobing2021/typora/raw/master/img/20200727174150.png)
 此时,如果再运行一个赋值语句:
 `StringBuffer str1 = str;`
 对应内存结构:
![image-20200727145543420](https://gitee.com/shaobing2021/typora/raw/master/img/20200727174151.png)
...
> 作者：will A
> 链接：https://juejin.im/post/5ef04be46fb9a0587e66efa7
> 来源：掘金

...
```shell
[root@192 ~]# touch hello.sh
[root@192 ~]# vim hello.sh
[root@192 ~]# sh hello.sh 
hello,world
[root@192 ~]# bash hello.sh 
hello,world
[root@192 datas]# sh /root/datas/hello.sh
hello,world
[root@192 datas]# ./hello.sh
-bash: ./hello.sh: 权限不够
#注意chmod指令
[root@192 datas]# chmod 777 hello.sh
[root@192 datas]# ll
总用量 4
-rwxrwxrwx. 1 root root 32 1月  29 23:22 hello.sh
[root@192 datas]# ./hello.sh
hello,world
```
...
cd /root/datas/
touch hello.txt
echo 'i love study' >> hello.txt
```

##### 1.3 定义规范

1. 变量名称可以由字母、数字、下划**线组成，不能以数字开头**。环境变量建议大写
2. 等号两侧不能有空格
...
> 在sh脚本中写echo $D 若控制台没有export D则执行sh脚本不会输出D
...
```shell
[root@192 datas]# expr `expr 2 + 3` \* 4
20
[root@192 datas]# echo $[(2+3)*4]
20
